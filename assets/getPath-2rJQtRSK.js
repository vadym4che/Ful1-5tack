import{_ as p,r as u,a as h,c as m,y as r,E as c,b as g,G as d,D as l,e as f,F as y}from"./index-JdpZRhYj.js";import w from"./LoaderView-Deb9K-P6.js";const v=["src"],S={__name:"AsyncFrame",props:["iframeSrc","iframeStyle","iframeClass"],setup(a){const s=u(!1),o=()=>setTimeout(()=>s.value=!0,0);return(i,n)=>(h(),m(y,null,[r(g("iframe",{src:a.iframeSrc,class:d(a.iframeClass),style:l(a.iframeStyle),frameborder:"0",ref:"frame",onLoad:o},null,46,v),[[c,s.value]]),r(f(w,{class:d([a.iframeClass,"placeholder"]),style:l(a.iframeStyle)},null,8,["class","style"]),[[c,!s.value]])],64))}},A=p(S,[["__scopeId","data-v-d37409db"]]),e=[{title:"Feedback App",name:"vue3-feedback-widget",stack:["Vue3","Vuetify","Firebase"],tags:["UI","FE","BE","DB"],desc:"This app showcases the power of Vue3 and Google modern and convenient cloud storage as Firebase Store. It also utilizes Vuetify - an easy and light Vue component library. It consists of 2 pages. One main allows you to post feedback with ratings and so on? and disallow votes more than once with the same email box address or phone number. The second page shows statistics of voting for users to understand their own role - that their actions impact the world - to say globally :)",path:"vue3-feedback-widget",orientation:"|",deps:["@vuelidate/core ^2.0.3","@vuelidate/validators ^2.0.4","dotenv ^16.3.1","firebase ^10.5.2","vee-validate ^4.11.8","vite-plugin-vuetify ^1.0.2","vue ^3.3.4","vuetify ^3.3.23"]},{title:"Weather App",name:"vue-weather-app",stack:["Vue3","axios","i18n","maps"],tags:["UI","FE","API"],desc:`The Vue Weather App is a feature-rich weather application developed using Vue.js. It provides a user-friendly interface with various functionalities. The project structure follows a clean organization, separating components, helpers, and views.
...
12. Day/Night Mode: Features a toggle between Day and Night theme-view modes.`,path:"vue-weather-app",orientation:"|",deps:["axios ^1.6.2","chart.js ^4.4.0","vue ^3.3.8","vue-chartjs ^5.2.0","vue-i18n ^9.8.0","vue-router ^4.2.5","vue3-google-autocomplete ^0.0.5"]},{title:"Multi-calendar App",name:"e-time",stack:["Vite","Vue3","SCSS"],tags:["UI","FE","API"],desc:"Didn't I mention before that I am a developer and love astro topics? So I desired to create an app within which I could see all calendar data in one place - i.e. lunar phases, date, and time to put it on an additional screen to track time-spending. And I also implement styling with great respect and love to Time whom I am worshiping and on whom I rely in all my dos. So I like to watch out for Time and spend it as effectively and positively as I can.",path:"e-time",orientation:"|",deps:["vue ^3.3.8","@vitejs/plugin-vue ^4.5.0","gh-pages ^6.1.0","sass ^1.69.5","vite ^5.0.0"]},{title:"If GPT was a dish - tech recipe",name:"gpt-cuisine-symphony",stack:["HTML","CSS","JS"],tags:["UI","FE","API"],desc:`In this gastronomic masterpiece, we explore the various ingredients that make up the harmonious blend of GPT-3.5 development. Each component plays a unique role, contributing to the symphony of code and creativity.
...
Was enjoyble to animate this fetched data displaying smoothily. Bulma is simple and nice, so I like it too.`,path:"react_dynamic-list-of-goods",orientation:"|",deps:["@cypress/react ^5.12.4","bulma ^0.9.3","postcss ^8.4.12","react ^17.0.2","react-dom ^17.0.2"],white_bg:!0},{title:"Rainbow divs toggler demo app",name:"div-toggle-colorizer",stack:["HTML","CSS","JS"],tags:["UI","FE","API"],desc:"This particular demo illustrates the power of JavaScript which creates all content and manages it interactively and smoothly via a few lines of code. When you click some specific div - it moves to the top. When you click on it a second time it moves to its initial place, and as result we have elements behavior if it has a memory state even if it has not.",path:"div-toggle-colorizer",orientation:"|",deps:[]},{title:"React Restaurant Landing App",name:"restaurant-react",stack:["HTML","CSS","JS","React"],tags:["UI","FE","API"],desc:"This is an example how easy is component-based approach to use in React.js, how easy and quick to prepair some landing page like this for any sort of bussiness representation.",path:"restaurant-react",orientation:"|",deps:["react ^18.2.0","react-dom ^18.2.0","react-icons ^4.6.0"]},{title:"React BEM Landing Responsive",name:"gpt3-react",stack:["React","HTML","CSS"],tags:["UI","FE","API"],desc:"This lightweight react SPA demonstrates the modern BEM approach in writing stylesheet blocks and has a responsive instead of a gummy interface. Also, it is a very cool thing in React - it is very easy to manage content when it is divided into small easily maintainable blocks. React changed many lives of developers having different backgrounds and working areas.",path:"gpt3-react",orientation:"|",deps:["react ^18.2.0","react-dom ^18.2.0","react-icons ^4.6.0","gh-pages ^4.0.0"]},{title:"Vue Weather Forecast",name:"weather-app",stack:["HTML","CSS","JS","Vue"],tags:["UI","FE","API"],desc:`The Vue.js Weather App is a simple web application that allows users to view weather information for different cities. It provides real-time weather data, including minimum and maximum temperatures, for selected locations.
...
'nuff said. Just app with Vue.js - Progressive JavaScript Framework!`,path:"weather-app",orientation:"|",deps:["core-js ^3.8.3","vue ^3.2.13"]},{title:"Vue Grocery Store with Cart",name:"food-cart-vue",stack:["HTML","CSS","JS","Vue"],tags:["UI","FE","API"],desc:`This is a Vue.js application for an online food ordering system. It allows users to browse products, add them to the cart, and place orders. The app provides a user-friendly interface for selecting and ordering food items.
Features:
...
+ Responsive design for a seamless experience on different devices.`,path:"food-cart-vue",orientation:"|",deps:["core-js ^3.8.3","vue ^3.2.13","vue-router ^4.0.3","@babel/core ^7.12.16","@vue/cli-service ~5.0.0","eslint ^7.32.0","gh-pages ^4.0.0","sass ^1.55.0"]},{title:"React livecoding - Cars",name:"react_live_coding_cars_table_task",stack:["HTML","CSS","JS","React"],tags:["UI","FE","API"],desc:`Here is just hour live-coding result displayed.
The task was to display table of cars with working lazy search and filtering by color. It's really simple!..`,path:"react_live_coding_cars_table_task",orientation:"|",deps:["bulma ^0.9.3","react ^17.0.2","react-dom ^17.0.2","react-scripts ^4.0.3"],white_bg:!0},{title:"Site with sticky header",name:"react_decompose",stack:["HTML","CSS","JS"],tags:["UI","FE"],desc:"",path:"react_decompose",orientation:"|",deps:[]},{title:"HTML5 Transforming JSON to List",name:"json-list",stack:["HTML","CSS","JS"],tags:["UI","FE","API"],desc:`JSON List is a simple web application that fetches JSON data from the https://jsonplaceholder.typicode.com/ API and displays it in a structured list format. This project demonstrates how to fetch and display JSON data using HTML, CSS, and JavaScript.
Here HTML5 the one of the most powerful features used in way as it used in every JavaScript framework - innerHTML() HTMLelement method.`,path:"json-list",orientation:"|",deps:[]},{title:"Bykes Store Landing",name:"layout_miami",stack:["HTML","CSS","SCSS","JS"],tags:["UI","FE","API"],desc:"",path:"layout_miami",orientation:"|",deps:[]},{title:"Multilayout Clock Widget",name:"lunar-solar-time",stack:["HTML","CSS","SCSS","JS"],tags:["UI","FE","API"],desc:"Project is inspired by idea of creating versatile calendar, that would calculate and display correct lunar day phase.",path:"lunar-solar-time",orientation:"|",deps:["nodemon ^2.0.22","sass ^1.62.1","astronomia ^4.1.1","julian ^0.2.0"]},{title:"FIRE'S'NOW - snowfall background",name:"fireSnow",stack:["HTML","CSS","SCSS"],tags:["UI","FE","API"],desc:"FIRESNOW® is a web page designed to create a captivating visual experience. It features falling snowflakes over a dark background, accompanied by animated text. The project aims to showcase creative CSS techniques for animation and styling. The project's HTML structure is minimal, with a basic layout consisting of a <div> element for snowflakes and sections for header and footer text. The document's metadata, including the title and favicon, is also defined.",path:"fireSnow",orientation:"|",deps:[]},{title:"Watch Widget SCSS",name:"layout_stop-watch",stack:["SCSS","SASS","HTML","CSS"],tags:["UI","FE","API"],desc:`It is very simple - thanks to the SASS preprocessor - watch widget, that is programmed to get synchronized with worldwide time with JavaScript and passing this time as data-attribute through layout to CSS.
...
All had been begun from strict desire to implement shiny sing logo animated, moreover for development purposes area react on click, - square change its's color to white after first click and to green after second one click on it.`,path:"AIB",orientation:"-",deps:[]},{title:"React-React-router-MUI: Table | Chart | List",name:"backendless-tabs-jsx",stack:["JS","React","React-router"],tags:["UI","FE","API"],desc:`This project serves as a template for a React-based application that implements tabs without backend integration. It showcases various components, including charts, lists, and tables, along with a navigation layout and a router component. The project utilizes modern web development tools and libraries such as React, React Router, Material-UI, and more.
...
Vue.js is imported via CDN: https://unpkg.com/vue@3/dist/vue.global.js`,path:"random-user-vue",orientation:"-",deps:[],white_bg:!0},{title:"The Web-dev base: Layout, Git, JS, TS",name:"devit-team",stack:["HTML","CSS","JS","TS"],tags:["UI","FE","API"],desc:`Here you'll find tasks related to Git, HTML/CSS, JavaScript, and more. Each task is organized in its own subfolder with detailed descriptions and implementations.

The most interesting block there is dedicated to JavaScript/TypeScript. Programming is really some kind of a passion...`,path:"devit-team",orientation:"-",deps:[]},{title:"Web Dev Essentials",name:"abz-agency-test-assignment",stack:["CSS","JS","React","MUI"],tags:["UI","FE","API"],desc:`The task involves implementing the following steps:
...
In addition could be said that there have been developed custom title tips as nice as with MUI or other UI libraries.`,path:"abz-agency-test-assignment",orientation:"-",deps:["classnames ^2.3.2","react ^18.2.0","react-dom ^18.2.0","react-scripts 5.0.1","gh-pages ^5.0.0"]},{title:"Nice Gadgets Store - Full-stack App",name:"product-catalog",stack:["CSS","JS","React","NodeJS"],tags:["UI","FE","BE","DB","API"],desc:`Product Catalog is a web application that allows users to browse for various products. It provides a user-friendly interface for viewing product details, managing product categories, and adding products to the cart.
...
Happy playing!`,path:"clicker-js",orientation:"-",deps:[]}];Array.prototype.shuffle=function(){return this.sort(()=>Math.random()-.5)};e.shuffle();t.shuffle();const b=[e[10],t[0],t[1],e[6],e[7],e[8],e[12],t[4],t[5],t[2],t[3],e[11],t[6],t[7],e[13],e[14],t[8],t[9],e[1],e[3],e[0],e[5],e[2],e[4],e[16],t[12],t[13],t[14],t[15],e[17],t[10],t[11],e[15]],k=(a,s)=>{const o=[];for(let i=0;i<a.length;i+=s){const n=a.slice(i,i+s);o.push(n)}return o},E=k(b,3);function C(a){return a.includes("https")?a:"https://vadym4che.github.io/"+a}export{A,E as c,C as g,b as p};
