...
Happy playing!`,path:"clicker-js",orientation:"-",deps:[]}];Array.prototype.shuffle=function(){return this.sort(()=>Math.random()-.5)};e.shuffle();t.shuffle();const T=[e[10],t[0],t[1],e[6],e[7],e[8],e[12],t[4],t[5],t[2],t[3],e[11],t[6],t[7],e[13],e[14],t[8],t[9],e[1],e[3],e[0],e[5],e[2],e[4],e[16],t[12],t[13],t[14],t[15],e[17],t[10],t[11],e[15]],A=(a,i)=>{const o=[];for(let s=0;s<a.length;s+=i){const r=a.slice(s,s+i);o.push(r)}return o},F=A(T,3);function M(a){return a.includes("https")?a:"https://vadym4che.github.io/"+a}export{R as A,F as c,M as g,T as p};
