const vertical = [
  {
    ...
    tags: ['UI', 'FE', 'BE', 'DB'],
    desc: 'This app demonstrates the capabilities of Vue3 and uses Firebase as a cloud storage solution. It incorporates Vuetify, a user-friendly Vue component library. The main page enables users to submit feedback with ratings while preventing duplicate votes from the same email or phone number. The second page displays voting statistics, emphasizing the users\' impact on a global scale.',
  ...
  },
  {
    ...
    stack: ['vite' ,'vue', 'scss'],
    tags: ['UI', 'FE', 'API'],
    desc: 'Being a devoted developer with a passion for astrological topics, I envisioned an app that consolidates all calendar-related information into a single, user-friendly interface. The app includes features such as lunar phases, date, and time, providing a comprehensive overview that I can conveniently display on an additional screen for efficient time tracking. My approach to styling reflects my deep respect and admiration for Time itself, which I consider essential in all aspects of my life. Through this app, I aim to keep a mindful watch over Time, utilizing it effectively and fostering positive engagement in all my endeavors.',
    path: 'e-time',
    orientation: '|',
    deps: [
      "vue ^3.3.8",
  ...
  },
  {
    ...
    tags: ['UI', 'FE', 'API'],
    desc: 'Dynamic List of Goods is a React web application designed to dynamically load and display a list of goods. The user can utilize different buttons to load various sets of goods, such as all goods, the first five goods, and goods with a specific attribute, like red goods. This project showcases React component rendering, dynamic data loading, and error handling. It is crafted using React, Bulma CSS for a clean aesthetic, and Font Awesome icons for additional visual appeal.\n\nAnimating the fetched data to achieve smooth displays was an enjoyable aspect of the project. The simplicity and aesthetics of Bulma further contributed to my positive experience with this project.',
  ...
  },
  {
    ...
    stack: ['html' , 'css', 'js'],
    tags: ['UI', 'FE', 'API'],
    desc: 'This demo showcases the versatility of JavaScript, enabling the creation and interactive management of content with just a few lines of code. Clicking on a specific div causes it to move to the top, and a second click restores it to its initial position. This results in an element exhibiting behavioral memory, even without an explicit state, providing a dynamic and interactive user experience.',
  ...
  },
  {
    ...
    stack: ['css', 'js', 'react'],
    tags: ['UI', 'FE', 'API'],
    desc: 'This demo serves as a testament to the simplicity and efficiency of the component-based approach in React.js. It highlights the ease and speed with which one can create a compelling landing page suitable for various business representations. Harnessing the power of React.js components, this demonstration underscores the agility and versatility of modern web development.',
  ...
  },
  {
    ...
    tags: ['UI', 'FE', 'API'],
    desc: 'This lightweight React Single Page Application (SPA) showcases the contemporary BEM (Block, Element, Modifier) approach for writing stylesheets. With a responsive design, it replaces the traditional static interface with a dynamic and adaptable one. One of the standout features of React is its seamless content management, where information is neatly organized into small, easily maintainable blocks. This demo underscores how React has revolutionized the lives of developers with diverse backgrounds and expertise, making content management a breeze.',
    path: 'gpt3-react',
    orientation: '|',
    deps: [
      "react ^18.2.0",
  ...
  },
  {
    ...
    tags: ['UI', 'FE', 'API'],
    desc: 'The Vue.js Online Food Ordering App is a versatile application that facilitates online food ordering. Users can effortlessly browse through a variety of food products, add items to their cart, and complete orders. Key features include the ability to explore a list of available food products, manage the shopping cart, and place orders. The app ensures a seamless user experience with its responsive design, catering to various devices for easy accessibility.',
    path: 'food-cart-vue',
    orientation: '|',
    deps: [
      "core-js ^3.8.3",
  ...
  },
  {
    ...
    stack: ['html', 'scss', 'js'],
    tags: ['UI', 'FE', 'API'],
    desc: 'Inspired by the concept of a versatile calendar, this project aims to calculate and display the correct lunar day phase. The goal is to create a dynamic and accurate representation of lunar cycles through an intuitive and user-friendly interface.',
  ...
  },
  {
    ...
    stack: ['html' ,'css', 'scss'],
    tags: ['UI', 'FE', 'API'],
    desc: 'FIRESNOW® is a visually captivating web page designed to offer a unique visual experience. The project showcases creative CSS techniques, featuring falling snowflakes against a dark background with animated text. With a minimal HTML structure, the layout includes a <div> element for snowflakes, along with sections for header and footer text. The project pays attention to detail, defining metadata such as title and favicon for a polished presentation.',
    path: 'fireSnow',
    orientation: '|',
    deps: [],
  },
  {
    ...
    stack: ['html', 'scss', 'js'],
    tags: ['UI', 'FE', 'API'],
    desc: 'This is a straightforward watch widget enhanced by the SASS preprocessor. The widget is designed to synchronize with worldwide time using JavaScript, passing this time as a data attribute through the layout to CSS. The second-hand animation mimics the behavior of an old mechanical clock, providing a nostalgic touch to the design.',
  ...
  },
  {
    ...
    stack: ['html', 'css', 'js'],
    tags: ['FE', 'JS'],
    desc: 'The AIB project is a web-based application that showcases a myriad of HTML, CSS, and JavaScript techniques, aiming to deliver an engaging and visually pleasing web experience. This user description outlines the project\'s key features and emphasizes distinctive tags, attributes, properties, and coding techniques. The development journey began with a clear intent to implement an animated, shining logo. For interactive elements, a square changes its color to white after the first click and to green after the second click, adding a dynamic touch for development purposes.',
    path: 'AIB',
    orientation: '|',
    deps: [],
  },
...
const horizontal = [
  ...
  },
  {
    ...
    tags: ['UI', 'FE', 'API'],
    desc: 'This project acts as a template for a React-based application featuring tabs without backend integration. It highlights a range of components, including charts, lists, and tables, within a navigation layout and a router component. Leveraging modern web development tools and libraries like React, React Router, and Material-UI, this project explores the implementation of various UI elements. Notably, the challenge I found intriguing was configuring the hash-router to function as a conventional browser-router without the hash pre-appender \'#\'.',
  ...
  },
  {
    ...
    stack: ['vue' ,'html', 'css'],
    tags: ['UI', 'FE', 'API'],
    desc: 'This simple Vue app offers a hands-on demonstration of effortlessly fetching and displaying user data. It seamlessly utilizes the placeholder API, https://randomuser.me/api, to showcase the power of Vue.js. Importantly, Vue.js is included through the CDN: https://unpkg.com/vue@3/dist/vue.global.js.',
  ...
  },
  {
    ...
    tags: ['UI', 'FE', 'API'],
    desc: 'This repository offers a diverse range of tasks spanning Git, HTML/CSS, JavaScript, and more. Dive into individual subfolders for each task, complete with detailed descriptions and implementations. One particularly intriguing section focuses on JavaScript/TypeScript, reflecting the passionate nature of programming and its various intricacies.',
    path: 'devit-team',
    orientation: '-',
    deps: [],
  },
  ...
  },
  {
    ...
    stack: ['html' ,'css', 'js', 'react'],
    tags: ['UI', 'FE', 'API'],
    desc: 'Explore the React Movies List & Add Form project! This web application, built with React, empowers you to manage a movie list effortlessly. Experience dynamic form validation using React stateful functional components, ensuring a smooth and error-free user interaction. Dive into the world of movies with a user-friendly interface, because who doesn\'t love movies?',
...

  {
    ...
    tags: ['UI', 'FE', 'API'],
    desc: 'Immerse yourself in this engaging Three.js demo, featuring a 3D cube that responds to arrow keyboard buttons. The Three.js library is seamlessly integrated via CDN at https://threejs.org/build/three.js. This example beautifully illustrates the simplicity and convenience of modern technologies in the digital landscape.',
    path: 'graphics-js',
    orientation: '-',
    deps: [],
  },
